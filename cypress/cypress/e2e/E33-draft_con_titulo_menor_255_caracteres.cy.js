...
describe("Pages - Create a complete valid Page with apriori data", () => {
    ...
    beforeEach(() => {
        ...
        pagesPage.AndScreenshot('E33-596','1');
    });

    it('E33 - Should create a new page successfully with apriori data', () => {
        cy.fixture('pages').then((data) => {
            ...
            pagesPage.AndScreenshot('E33-596','8');
        });
    });
});
