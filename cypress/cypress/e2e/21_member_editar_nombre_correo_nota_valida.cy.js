...
describe("Edit Member - Valid Name, Email, Note", () => {
    ...
    it('Should Edit a Member', () => {
        ...
        let name = jsonData2.name
        let email = jsonData2.email
        let note = jsonData2.note
        GivenStepsMembers.givenUpdateMemberForm(name,email,note)
        
        // When the user clicks on Save
        WhenStepsMembers.whenClickSaveMember()
        
        //Then the user should see the updated member
        ThenStepsMembers.thenSeeUpdatedMember(name,  email)
