...
describe("83_create_post_empty_with_XCard_full", () => {
    let data = [];
    before(() => {
    ...
    it("83_create_post_empty_with_XCard_full", () => {
        ...
        GivenPosts.AndInputTitleXCard(data["title1"]);
        GivenPosts.AndInputDescriptionXCard(data["description"]);
        GivenPosts.AndClickSettingsPost();
